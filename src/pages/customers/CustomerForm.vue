            ...
            <form @submit.prevent="submit">
                <div class="p-6 md:p-8 flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <InputText id="phone" v-model="form.phone" type="text" placeholder="Phone number..." fluid
                            class="bg-surface-50! focus:bg-white!" :invalid="!!errors.phone" />
                        <Message v-if="errors.phone" severity="error" size="small" variant="simple">
                            {{ errors.phone[0] }}
                        </Message>
                    </div>

                    <div class="flex justify-end pt-4 mt-4 border-t border-surface-100">
